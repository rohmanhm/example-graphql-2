...
declare interface sequelize$BelongsToGetAssociationMixin<TInstance>{
     ...
     */
    (options?: sequelize$BelongsToGetAssociationMixinOptions): Promise<TInstance | null >
}
...
declare interface sequelize$HasOneGetAssociationMixin<TInstance>{
     ...
     * @param options The options to use when getting the association.
     */
    (options?: sequelize$HasOneGetAssociationMixinOptions): Promise<TInstance | null >
}
...
declare interface sequelize$HasManyGetAssociationsMixin<TInstance>{
    ...
    /**
     * Get everything currently associated with any, using an optional where clause.
 ...
 * @see  Instance
*/
declare interface sequelize$HasManyCreateAssociationMixin<TAttributes, TInstance>{
     ...
     */
    (values?: TAttributes, options?: sequelize$HasManyCreateAssociationMixinOptions | sequelize$CreateOptions): Promise<TInstance >
}
...
declare interface sequelize$HasManyCountAssociationsMixin {
    ...
    /**
     * Count everything currently associated with any, using an optional where clause.
 ...
 * @see  Instance
*/
declare interface sequelize$BelongsToManyCreateAssociationMixin<TAttributes, TInstance, TJoinTableAttributes>{
     ...
     */
    (values?: TAttributes, options?: sequelize$BelongsToManyCreateAssociationMixinOptions | sequelize$CreateOptions | TJoinTableAttributes): Promise<TInstance >
}
...
Cyclic dependency found. 'users' is dependent of itself`. If you encounter any, you should either disable
...
declare type sequelize$DataTypeString = any


declare type sequelize$DataTypeChar = any
...
declare type sequelize$DataTypeNumber = any
 ...
 */
declare type sequelize$BaseError = {} & Error & any
...
declare interface sequelize$Hooks<TInstance>{
    ...
    */
     ...
     */
    beforeSync(name: string, fn: (options: sequelize$SyncOptions) => void): void,
    beforeSync(fn: (options: sequelize$SyncOptions) => void): void,
     ...
     * @param fn A callback function that is called with options passed to Model.sync
     */
    afterSync(name: string, fn: (options: sequelize$SyncOptions) => void): void,
    afterSync(fn: (options: sequelize$SyncOptions) => void): void,
     ...
     */
    beforeBulkSync(name: string, fn: (options: sequelize$SyncOptions) => void): void,
    beforeBulkSync(fn: (options: sequelize$SyncOptions) => void): void,
     ...
     * @param fn A callback function that is called with options passed to sequelize.sync
     */
    afterBulkSync(name: string, fn: (options: sequelize$SyncOptions) => void): void,
    afterBulkSync(fn: (options: sequelize$SyncOptions) => void): void
}
...
declare interface sequelize$Instance<TAttributes>{
    ...
    */
    set(key: string, value: any, options?: sequelize$InstanceSetOptions): any,
    set(keys: Object, options?: sequelize$InstanceSetOptions): any,
    setAttributes(key: string, value: any, options?: sequelize$InstanceSetOptions): any,
    setAttributes(keys: Object, options?: sequelize$InstanceSetOptions): any,
    ...
    */
    save(options?: sequelize$InstanceSaveOptions): Promise<any>,
    ...
    */
    reload(options?: sequelize$FindOptions): Promise<any>,
    ...
    */
    ...
    update(
        key: string,
        value: any,
        options?: sequelize$InstanceUpdateOptions): Promise<any>,
    update(keys: Object, options?: sequelize$InstanceUpdateOptions): Promise<any>,
    updateAttributes(
        key: string,
        value: any,
        options?: sequelize$InstanceUpdateOptions): Promise<any>,
    updateAttributes(keys: Object, options?: sequelize$InstanceUpdateOptions): Promise<any>,
    ...
    */
    increment(
        ...
        options?: sequelize$InstanceIncrementDecrementOptions): Promise<any>,
...
declare interface sequelize$IncludeOptions {
    ...
    model?: sequelize$Model<any, any>,
        ...
        attributes?: sequelize$FindOptionsAttributesArray | {
            include?: sequelize$FindOptionsAttributesArray,
 ...
 */
declare type sequelize$FindOptionsAttributesArray = Array<string |
    [string, string] |
    sequelize$fn |
    [sequelize$fn, string] |
    sequelize$cast |
...
declare type sequelize$FindOptions = {
     ...
     * A hash of attributes to describe your search. See above for examples.
     */
    where?: sequelize$WhereOptions | sequelize$fn | Array<sequelize$col | sequelize$and | sequelize$or | string>,
 ...
 * Options for Model.findOrInitialize method
 */
declare type sequelize$FindCreateFindOptions<TAttributes>= {
...
declare type sequelize$Model<TInstance, TAttributes>= {
     ...
     * @param options 
    */
    schema(schema: string, options?: sequelize$SchemaOptions): any,
    ...
    */
    scope(
        options?: string | sequelize$ScopeOptions | sequelize$WhereOptions | Array<string | sequelize$ScopeOptions | sequelize$WhereOptions>): any,
    ...
    */
    ...
    findById(
        ...
        options?: sequelize$FindOptions): Promise<TInstance | null>,
    findByPrimary(
        identifier?: number | string,
        options?: sequelize$FindOptions): Promise<TInstance | null>,
     ...
     * instance.
     */
    findOne(options?: sequelize$FindOptions): Promise<TInstance | null>,
    find(options?: sequelize$FindOptions): Promise<TInstance | null>,
...
declare interface sequelize$DefineOptions<TInstance>{
    ...
    */
    ...
    `this.constructor.super_.prototype.toJSON.apply(any, arguments)`
    */
    ...
    `this.constructor.prototype.find.apply(any, arguments)`
    */
    classMethods?: Object,
    schema?: string,
...
declare type sequelize$Sequelize = {
    ...
    */
    transaction(
        ...
        autoCallback: (t: sequelize$Transaction) => any): Promise<any>,
    transaction(autoCallback: (t: sequelize$Transaction) => any): Promise<any>,
...
} & sequelize$SequelizeStaticAndInstance & any
